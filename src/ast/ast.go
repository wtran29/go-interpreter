...
// IfExpression represents the if statements
...
// BlockStatement represents the block of code separated by brackets
...
// CallExpression represents an expression that results
// in a function when evaluated
