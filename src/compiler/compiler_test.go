...
// compilerTestCase defines the input, which constants we expect
// in the constant pool and which instructions we expect the compiler to generate
...
// TestStringExpressions makes sure compiler knows how to treat string litrals as constants.
func TestStringExpressions(t *testing.T) {
	tests := []compilerTestCase{
		{
			input:             `"funckey"`,
			expectedConstants: []interface{}{"funckey"},
			expectedInstructions: []code.Instructions{
				code.Make(code.OpConstant, 0),
				code.Make(code.OpPop),
			},
		...
		{
			input:             `"func" + "key"`,
			expectedConstants: []interface{}{"func", "key"},
			expectedInstructions: []code.Instructions{
				code.Make(code.OpConstant, 0),
				code.Make(code.OpConstant, 1),
				code.Make(code.OpAdd),
...
// testConstants iterates through the expected constants and compares them with the actual constants
